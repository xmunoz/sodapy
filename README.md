[![Latest Version](https://pypip.in/version/sodapy/badge.svg?style=flat)](https://pypi.python.org/pypi/sodapy/) [![Build Status](https://travis-ci.org/xmunoz/sodapy.svg?branch=master)](https://travis-ci.org/xmunoz/sodapy)
